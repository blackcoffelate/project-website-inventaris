...
if(isset($_POST['nama_series'])){
    require_once "function/series_add.php";
}
                                    ...
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Series <span class="required">*</span></label>
                                                <div class="col-md-8 col-sm-8 ">
                                                    <input type="text" id="first-name" required="required" name="nama_series" class="form-control ">
                                                </div>
                                            </div>
