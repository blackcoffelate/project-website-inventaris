                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group row ">
                                            <label class="control-label col-md-3 col-sm-3 ">Nomor Inventori</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <select class="selectpicker col-md-12 col-sm-12 form-control"
                                                    data-live-search="true">
                                                    <option data-tokens="ketchup mustard" disabled selected>-- tipe
                                                        pengadaan --</option>
                                                    <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                                    <option data-tokens="frosting">Sugar, Spice and all things nice
                                                    </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <select class="selectpicker col-md-12 col-sm-12 form-control"
                                                    data-live-search="true">
                                                    <option data-tokens="ketchup mustard" disabled selected>-- unit
                                                        pengadaan --</option>
                                                    <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                                    <option data-tokens="frosting">Sugar, Spice and all things nice
                                                    </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <select class="selectpicker col-md-12 col-sm-12 form-control"
                                                    data-live-search="true">
                                                    <option data-tokens="ketchup mustard" disabled selected>-- penyerah
                                                        --</option>
                                                    <option data-tokens="mustard">Burger, Shake and a Smile</option>
                                                    <option data-tokens="frosting">Sugar, Spice and all things nice
                                                    </option>
