...
if(isset($_POST['nama_unit_pengadaan'])){
    require_once "function/unit_pengadaan_add.php";
}
            ...
            <div class="right_col" role="main">
                ...
                <div class="row" style="display: block;">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Input Data <small>Unit Pengadaan</small></h2>
                                    ...
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Unit Pengadaan <span class="required">*</span></label>
                                                <div class="col-md-8 col-sm-8 ">
                                                    <input type="text" id="first-name" required="required" name="nama_unit_pengadaan" class="form-control ">
                                                </div>
                                            </div>
                ...
                <div class="row" style="display: block;">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Master Data <small>Unit Pengadaan</small></h2>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                    </li>
                                    <li><a class="close-link"><i class="fa fa-close"></i></a>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            <p class="text-muted font-13 m-b-30">
                                                Kumpulan data unit pengadaan barang.
                                            </p>
